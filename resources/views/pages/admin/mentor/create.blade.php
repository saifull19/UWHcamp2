                                        ...
                                        <div class="px-4 py-5 sm:p-6">
                                            ...
                                            <div class="grid grid-cols-6 gap-6">
                                                ...
                                                <div class="col-span-6 -mb-6">
                                                    ...
                                                    <label for="title" class="block mb-3 font-medium text-gray-700 text-md">Nama Mentor</label>

                                                </div>

                                                <div class="col-span-6 sm:col-span-3">
                                                    <input placeholder="Mentor name ??" type="text" name="name" id="name" autocomplete="name" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('name') }}" required>
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    <input placeholder="Your Email.." type="email" name="email" id="email" autocomplete="email" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('email') }}" required>
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    <input placeholder="Your Password" type="password" name="password" id="password" autocomplete="password" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
