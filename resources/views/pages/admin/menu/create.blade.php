    ...
    <main class="h-full overflow-y-auto">
                ...
                <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
                    <ol class="inline-flex p-0 list-none">
                        ...
                        <li class="flex items-center">
                            <a href="#" class="font-medium">Add Your Menu</a>
                        </li>
                                        ...
                                        <div class="px-4 py-5 sm:p-6">
                                            ...
                                            <div class="grid grid-cols-6 gap-6">
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    <input placeholder="Menu Name,,?" type="text" name="nama_menu" id="nama_menu" autocomplete="nama_menu" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('nama_menu') }}" required>
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    ...
                                                    <input placeholder="No urut master" type="number" name="master_menu" id="master_menu" autocomplete="master_menu" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('master_menu') }}" required>
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                   ...
                                                   <input placeholder="No urut letak menu" type="number" name="no_urut" id="no_urut" autocomplete="no_urut" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('no_urut') }}" required>
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                   ...
                                                   <input placeholder="No urut letak menu" type="text" name="url" id="url" autocomplete="url" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('url') }}" required>
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                   ...
                                                   <input placeholder="No urut letak menu" type="text" name="icon" id="icon" autocomplete="icon" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('icon') }}" required>
