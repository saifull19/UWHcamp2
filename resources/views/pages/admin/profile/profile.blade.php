                                            ...
                                            <div class="grid grid-cols-6 gap-6">
                                                <div class="col-span-6">
                                                    ...
                                                    <div class="flex items-center mt-1">
                                                        ...
                                                        <a href="{{ route('admin.delete.photo.profile') }}" type="button" class="px-3 py-2 ml-5 text-sm font-medium leading-4 text-red-700 bg-transparent rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" onclick="return confirm('are you sure want to delete your photo?')">
                                                            Delete
                                                        </a>
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    @if ($errors->has('address'))
                                                        <p class="text-red-500 mb-3 text-sm">{{ $errors->first('address') }}</p>
                                                    @endif
