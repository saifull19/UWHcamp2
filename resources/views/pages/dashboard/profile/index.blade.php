        ...
        >
            ...
            >
                <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <p
                        class="pt-2 text-base flex items-center justify-center lg:justify-start"
                    >
                        <svg
                            class="h-4 fill-current text-green-700 pr-4"
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        {{ $user->detail_user->contact_number ?? '' }}
                    </p>
                    ...
                    <div class="pt-12 pb-8">
                        <a href="{{ route('member.profile.editt') }}"
            ...
            <div class="w-full lg:w-2/5">
                ...
                @if (auth()->user()->detail_user()->first()->photo != NULL)
                             ...
                             <img src="{{ url(Storage::url(auth()->user()->detail_user()->first()->photo)) }}" alt="Photo Profile" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
