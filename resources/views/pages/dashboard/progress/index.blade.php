                    ...
                    <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                        <div class="col-span-8">
                            ...
                            <p class="text-sm text-gray-400">
                                {{ auth()->user()->order_freelancer()->count() }} Total Members
                            </p>
                                ...
                                <table class="w-full" aria-label="Table">
                                    ...
                                    <thead>
                                        <tr class="text-sm font-normal text-left text-gray-900 border-b border-b-gray-600">
                                            <th class="py-4" scope="">Member Name</th>
                                            <th class="py-4" scope="">Service Title</th>
                                            <th class="py-4" scope="">Nomor Hp</th>
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        @forelse ($orders as $order)
                                                ...
                                                <div class="flex items-center text-sm">
                                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                        ...
                                                        @if ($order->user_buyer->detail_user->photo != NULL)
                                                            ...
                                                            <img class="object-cover w-full h-full rounded-full" src="{{ url(Storage::url($order->user_buyer->detail_user->photo)) }}" alt="" loading="lazy" />

                                                        @else
                                                            
                                                            <img class="object-cover w-full h-full rounded-full" src="{{ url('https://randomuser.me/api/portraits/men/1.jpg') }}" alt="" loading="lazy" />
                                            ...
                                            <td class="px-1 py-5 text-xs text-red-500">
                                                ...
                                                {{ $order->user_buyer->detail_user->contact_number }} 
                                            </td>

                                                {{-- @if ($order->payment_status == 'Waiting')
                                                    <td class="px-1 py-5 text-sm">
                                                        <div class="mr-5 py-2 mt-2 text-center text-white rounded-xl bg-serv-button ">{{ $order->payment_status ?? '' }}</div>
                                                    </td>
                                                @else
                                                    <td class="px-1 py-5 text-sm">
                                            ...
                                            <td class="px-1 py-5 text-sm">
                                                ...
                                                <a href="{{ route('member.progress.show', $order->id) }}" class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-email">
                                                    Details</a>
                                                {{-- @if ($order->order_status_id == '1') --}}
                                                    ...
                                                    @elseif($order->order_status_id == '4')
                                                        ...
                                                        <a href="{{ route('member.reject.order', $order->id) }}" class="px-4 py-2 mt-2 text-left rounded-xl bg-serv-email text-white">
                                                            Reject
                                                        </a>
