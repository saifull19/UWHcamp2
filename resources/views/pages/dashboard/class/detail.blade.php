                ...
                <div class="card-header card-header-success">
                  <div class="ct-chart" >
                    <div class="ratio ratio-16x9">
                      <iframe src="{{ $materi[1]->url }}" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                  </div>
                </div>
  ...
  <div class="fixed-plugin">
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="button-container">
          <a href="{{ route('corporate.landing') }}" target="_blank" class="btn btn-default btn-block">
            View Documentation
          </a>
        </li>
