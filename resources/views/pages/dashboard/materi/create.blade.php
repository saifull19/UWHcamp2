                                        ...
                                        <div class="px-4 py-5 sm:p-6">
                                            ...
                                            <div class="grid grid-cols-6 gap-6">
                                                ...
                                                <div class="col-span-6 -mb-6">
                                                    ...
                                                    <label for="service_id" class="block mb-3 font-medium text-gray-700 text-md">Service ID</label>
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    <p class="block mb-3 text-sm text-gray-700">
                                                        Description 1 pada materi yang kamu berikan?
                                                    </p>
                                                    ...
                                                    @endpush
                                                     ...
                                                     <textarea name="description[]" id="summernotee" cols="30" rows="10">{{ old('description') }}</textarea>
