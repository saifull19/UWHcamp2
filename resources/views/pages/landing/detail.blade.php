                        ...
                        <div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'description' }" id="tab_wrapper">
                            ...
                            <div x-show.transition.duration.500ms="tab === 'description'" class="leading-8 text-md">
                                ...
                                <div class="mt-4 mb-8 content-description">
                                    ...
                                    <p class="mb-4 font-semibold text-grey-50">
                                    {{ $service->note ?? '' }}
                                    </p>
                                ...
                                <a href="https://wa.me/081233285849?text=Hi, Saya ingin bertanya tentang Bootcamp di UWHcamp ini??" class="mb-4 font-medium">
...
@push('after-script')
    <script>
        function gallery() {
            return{
                featured: 'https://source.unplash.com/_SgRNwAVNKw/1600x900/',
                active: 1,
