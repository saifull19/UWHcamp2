    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          ...
          <p class="uppercase tracking-loose w-full">Belajar secara terstruktur sehingga target belajar lebih mudah tercapai di UWHcamp</p>
          ...
          <p class="leading-normal text-2xl mb-8">
           Jangan sampai bingung memulai dari mana. Tersedia berbagai Learning Path yang membantumu belajar sesuai kebutuhanmu dengan alur yang jelas.
          </p>
